...
public static class ContentManagementSystem
{
    ...
    public static IEnumerator C_CheckContentConsistency(ContentVerifyContext result)
    {
        if (result == null)
        {
            yield break;
    ...
    public static IEnumerator C_SyncContentManifest()
    {
    ...
    private static IEnumerator C_VerifyContentMeta(ContentMeta localMeta, string id, string schema, ContentVerifyContext ctx)
    {
        if (ctx == null)
        {
            yield break;
    ...
    /// 매니페스트  본문 업데이트
    /// </summary>
    private static IEnumerator C_UpdateContentManifest(ContentVerifyContext ctx)
    {
        if (ctx == null)
        {
            yield break;
    ...
    /// 카탈로그 본문 다운로드 + 로컬 저장
    /// </summary>
    private static IEnumerator C_UpdateContentCatalog(ContentVerifyContext ctx)
    {
        if (ctx == null)
        {
            yield break;
    ...
    /// </summary>
    private static IEnumerator C_UpdateContentBundle(ContentVerifyContext ctx, ContentCatalog catalog)
    {
        if (ctx == null)
        {
            yield break;
